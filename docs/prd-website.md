...
| File | Content |
|------|---------|
| `knowledge/design/pyb-design-system-web.html` | Tokens, colors, typography, components |
| `knowledge/design/pyb-design-system-photobooth.html` | Homepage, Magic Mirror, Party Booth, Form mockups |
| `knowledge/design/pyb-design-system-dj.html` | DJ Hub page mockup |
| `knowledge/brand/brand.md` | Brand guide, services, pricing |
