...
3. **DJ Gianni Profile** — Real photo (`docs/output/images/dj-gianni/profile/profiel.jpeg`), coral accent (#f0654a). Name: "DJ GIANNI". Tagline: "Elke set een feest, elk feest een herinnering". Bio. Genre tags (coral): Afro Beats, Caribbean, Nederlands, Hits. Social links: IG, TikTok, SoundCloud.
