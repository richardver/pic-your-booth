...
| **DJs** | €149 | DJ Gianni (Afro/Caribbean/Hits) & Milø (Tech House/House/Deep) |
...
│   │   ├── djs/           → DJ Gianni (brand, social, photos) + Milø
...
3. **Individual DJ brands** — DJ Gianni (coral), Milø (cyan)
