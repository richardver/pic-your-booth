...
export const GENRE_TOKENS: Record<Genre, { accent: string; dim: string; name: string }> = {
  ...
  // Milø genres (cool palette — each genre has its own color)
  house:     { accent: '#34d399', dim: 'rgba(52,211,153,0.10)', name: 'Tech House' },
  techno:    { accent: '#38bdf8', dim: 'rgba(56,189,248,0.10)', name: 'House' },
  deep:      { accent: '#8b5cf6', dim: 'rgba(139,92,246,0.10)', name: 'Deep' },
};
