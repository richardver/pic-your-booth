...
### Structured Variation Testing (One Variable at a Time)

| Test Priority | Variable | What to Test |
|--------------|----------|-------------|
| 1 | **Hook / Opening** | Different first lines or first 3 seconds |
| 2 | **Value proposition** | Different benefits (save time vs save money vs experience) |
| 3 | **Social proof type** | Numbers vs names vs testimonials vs event footage |
| 4 | **CTA** | Different action verbs and urgency levels |
| 5 | **Offer** | Free consultation vs package deals vs limited time |
...
| **All platforms** | Substantiate all claims, honest testimonials, clear sponsorship disclosure |
