...
### PYB Font Pairing (Brand Standard)

| Usage | Font | Weight | Notes |
|-------|------|--------|-------|
| All headings, nav, prices, labels | Bebas Neue | 400 (uppercase) | Display font for impact |
| All body text, descriptions, forms | Space Grotesk | 300-700 | Clean, modern, readable |

This pairing is shared across all segments (photobooth + DJ pages) — unified brand typography. See `brand.md` and `prd-website.md` for the canonical definition.
