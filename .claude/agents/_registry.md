...
| Brand | Brand Compliance | brand, tone, voice, review, audit, compliance, quality check | `brand.md` | Read, Grep, Glob |
...
| Brand | Brand | Brand | Designer | Architect |
...
|---|---|---|
| **Awareness** | Ad Specialist, Social Media | Reach target audience |
| **Consideration** | Designer, Ad Specialist | Convert visitors to form submissions |
| **Proposal** | Designer | Smooth proposal form experience |
| **Booking** | Brand | Consistent, professional communication |
