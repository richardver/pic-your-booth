...
### Voice & Tone
- **Personality**: Professional. Creative. Fast-moving.
- **Tone**: Confident, energetic, approachable, direct. No fluff. "Geen gelul."
- **Language**: Dutch primary (NL market), English when needed
...
- **CRITICAL**: Pricing errors or inconsistent service descriptions
- **WARNING**: Tone mismatch (too corporate, too casual for segment)
- **WARNING**: Missing value differentiator (sounds generic)
...
- [ ] Highlights what makes PYB different (quality equipment, DJ combo, family energy)
