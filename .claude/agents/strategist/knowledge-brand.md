...
**Key identity markers:** Gold = photobooth, Violet = DJ hub, Coral = DJ Gianni, Cyan = DJ Milø. No red, no pink. Gold buttons always black text.
...
└── DJs (separate service section)
    ...
    └── DJ Milø - cyan accent - house, techno
```
...
| DJ Milø | Photobooth operator & DJ | House, techno - cyan accent |
