...
Premium DSLR photobooth with professional lighting and direct printing. The flagship product — "MEEST GEKOZEN" badge on website.
...
- **Who:** Premium events — weddings, corporate events, high-end parties
- **Tone:** Premium, polished, VIP experience
- **Job-to-be-done:** "I want to create an unforgettable experience for my guests, so they talk about my event for weeks and I look like an amazing host."

## USPs (Website)

1. **Foto's Die Je Wilt Inlijsten** — DSLR quality, not tablet quality
...
| Component | Detail |
|---|---|
| Camera | Canon EOS 650D (DSLR) |
| Lighting | Professional studio lights |
| Printing | On-site direct thermal printing |
| Mirror | Full-length interactive mirror display |
| Props | Standard props included; luxe props with VIP upgrade |
| Backdrop | Standard white; custom with VIP upgrade |
