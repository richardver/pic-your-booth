...
Platform-specific guides. Full reference in `.claude/agents/social-media/knowledge-platforms-full.md`.
...
|---|---|---|---|
| Instagram Feed | Carousel, image | 3-4x/week | Portfolio, brand |
...
1. Opening line that stops the scroll
2. 2-3 lines of value or context
3. Clear CTA (save, share, comment, link in bio)
4. 20-30 relevant hashtags (mix of niche, medium, large, mega)
